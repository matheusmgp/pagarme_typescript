import { HttpExceptionResponse, HttpExceptionResponseProps } from '@src/presenters/http-exception.presenter';
import { HttpResponse } from '@src/presenters/http.presenter';
